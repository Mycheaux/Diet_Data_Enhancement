"""Run the NutriMatch paper-style figure notebook as a console job.

This executes code cells from nutrimatch_paper_figures_with_enhancements.ipynb
with DDE_RUN_TRAINING=1, so SageMaker/Jupyter can disconnect without stopping
the long model run.
"""
...
NOTEBOOK_NAME = "nutrimatch_paper_figures_with_enhancements.ipynb"
...
def main() -> int:
    ...
    notebook_path = project_root / "downstream_analysis/Nutrimatch_manual" / NOTEBOOK_NAME
    output_dir = project_root / "downstream_analysis/tasks/nutrimatch_paper_figures_with_enhancements/outputs"
