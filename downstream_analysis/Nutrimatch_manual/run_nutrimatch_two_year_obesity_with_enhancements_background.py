"""Run the two-year overweight/obesity NutriMatch benchmark notebook.

This executes nutrimatch_two_year_obesity_with_enhancements.ipynb with
...
NOTEBOOK_NAME = "nutrimatch_two_year_obesity_with_enhancements.ipynb"
...
def main() -> int:
    ...
    output_dir = project_root / "downstream_analysis/tasks/nutrimatch_two_year_obesity_with_enhancements/outputs"
