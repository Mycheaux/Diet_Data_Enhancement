#!/usr/bin/env python
"""Run Diet Data Enhancement Benchmark I outside the notebook browser session.

Use this from the TRE console with nohup. The script executes the notebook's
code cells with DDE_RUN_TRAINING=1, so the expensive model training writes
cached metrics and figures to the notebook-named output folder.
"""
...
def main() -> int:
    ...
    notebook_path = Path(__file__).with_name("diet_data_enhancement_benchmark_I.ipynb")
